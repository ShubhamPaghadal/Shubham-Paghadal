...
const ProjectCard = ({
    ...
    const project = { id, category, title, description, images, layout, link, badge, badgeColor };
                ...
                >
                    ...
                    <div className="flex justify-center lg:justify-start pt-4">
                        <motion.button
                            ...
                            className="inline-flex items-center gap-3 text-brand-yellow font-bold group relative py-3 px-1 overflow-hidden cursor-pointer bg-transparent border-none"
                            whileHover="hover"
                        >
